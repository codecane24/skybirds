...
export const PHONE_COUNTRY_OPTIONS: PhoneCountryOption[] = [
  ...
  { code: '+441481', label: 'Guernsey (+441481)' },
  ...
  { code: '+441624', label: 'Isle of Man (+441624)' },
  { code: '+972', label: 'Israel (+972)' },
  { code: '+39', label: 'Italy (+39)' },
  { code: '+1876', label: 'Jamaica (+1876)' },
  { code: '+81', label: 'Japan (+81)' },
  { code: '+441534', label: 'Jersey (+441534)' },
  ...
  { code: '+262', label: 'Mayotte / Reunion (+262)' },
...
const VALID_COUNTRY_CODES = new Set(PHONE_COUNTRY_OPTIONS.map((option) => option.code));

export function normalizeCountryCode(countryCode?: string | null) {
  const trimmedCode = countryCode?.trim() || '';
  return VALID_COUNTRY_CODES.has(trimmedCode) ? trimmedCode : DEFAULT_COUNTRY_CODE;
}
...
export function formatPhoneNumber(phone?: string | null, countryCode?: string | null) {
  ...
  return `${normalizeCountryCode(countryCode)} ${sanitizedPhone}`;
}